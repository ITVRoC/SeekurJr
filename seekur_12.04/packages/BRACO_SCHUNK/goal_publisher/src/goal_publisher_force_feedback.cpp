...
void EndEffectorCallback(const sensor_msgs::JointState::ConstPtr& end_effector_pose)
{
	button_go = joy_test->buttons[0];
	//std::cout << button->grey_button;
}
...
int main(int argc, char **argv)   
{
    ...
    ros::Subscriber Button_sub = n.subscribe("end_effector_pose", 1000, EndEffectorCallback);
